...
target1 = """    onOpenPdfInAppViewer: () -> Unit,
    onSaveProfile: () -> Unit = {}
) {
    val scrollState = rememberScrollState()
    Column("""

replacement1 = """    onOpenPdfInAppViewer: () -> Unit,
    onSaveProfile: () -> Unit = {}
) {
    val scrollState = rememberScrollState()
...
target2 = """        Spacer(modifier = Modifier.height(20.dp))
        // Vector PDF Live Canvas Screen"""

replacement2 = """        Spacer(modifier = Modifier.height(20.dp))
...
target2b = """        Spacer(modifier = Modifier.height(20.dp))
        // Vector PDF Live Canvas Screen"""

target2c = """        Spacer(modifier = Modifier.height(20.dp))

        // Vector PDF Live Canvas Screen"""

if target2 in content:
    content = content.replace(target2, replacement2)
elif target2b in content:
    content = content.replace(target2b, replacement2)
elif target2c in content:
    content = content.replace(target2c, replacement2)
else:
