...
content = content.replace("    PDF_READER", tool_enum)

desc_enum = """                QR_BARCODE -> "Ultra-fast QR and Barcode scanner and creator with zero app size impact"
                PDF_READER"""
content = content.replace("                PDF_READER", desc_enum)
