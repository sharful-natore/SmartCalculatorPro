...
old_fab = """                val infiniteTransition = rememberInfiniteTransition(label = "ai_gradient")
...
new_fab = """                val infiniteTransition = rememberInfiniteTransition(label = "ai_gradient")
                ...
                val glowingColors2 = remember { glowingColors1.drop(7) + glowingColors1.take(7) + glowingColors1[7] }
                val glowingColors3 = remember { glowingColors1.drop(14) + glowingColors1.take(14) + glowingColors1[14] }
