...
target = """    onGenerateFresherAi: () -> Unit
) {
...
replacement = """    onGenerateFresherAi: () -> Unit
) {
    val scrollState = rememberScrollState()
...
if target in content:
    ...
    with open("app/src/main/java/com/example/ui/screens/tools/AtsCvBuilderTool.kt", "w") as f:
        f.write(content)
    print("Success fixing experience tab")
else:
    print("Target not found for fixing experience tab")
