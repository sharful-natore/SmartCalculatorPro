...
def get_bn_pronoun(word):
    pronoun_map = {
        ...
        "consecutive": "কনসিকিউティブ", "consensus": "কনসেনসাস", "consent": "কনসেন্ট", "consequence": "কনসিকোয়েন্স",
        ...
        "discount": "ডিসকাউন্ট", "discourage": "ডিসকারেজ", "discourse": "ডিসকোর্স", "discover": "ডিসকাভার",
        ...
        "divergent": "ডাইভারজент", "diverse": "ডাইভার্স", "divert": "ডাইভার্ট", "divide": "ডিভাইড",
        ...
        "encircle": "এনসার্কেল", "enclose": "এনক্লোজ", "encounter": "এনকাউন্টার", "encourage": "এনকারেজ",
        ...
        "vanish": "ভ্যানিশ", "variable": "ভ্যারিয়েবল", "vast": "ভাস্ট", "vehement": "ভিহিমент",
...
print(f"Successfully generated {len(full_dataset)} words JSON dataset!")
