...
object QuranMetadata {
    private val banglaNames = mapOf(
        ...
        61 to "আস-সফ", 62 to "আল-জুমুআাহ", 63 to "আল-মুনাফিকূন", 64 to "আত-তাগাবুন", 65 to "আত-ত্বলাক",
        ...
        96 to "আল-আলাক", 97 to "আল-কদর", 98 to "আল-বাইয়্যিনাহ", 99 to "যালযালাল", 100 to "আল-আদিয়াত",
