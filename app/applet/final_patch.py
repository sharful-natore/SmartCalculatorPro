...
# Project root is /app/applet
base_path = "/app/applet"
file_path = os.path.join(base_path, "app/src/main/java/com/example/ui/screens/tools/AtsCvBuilderTool.kt")
...
with open(file_path, "w") as f:
    f.write(content)
print("Applied all Live Edit Save button changes successfully")
