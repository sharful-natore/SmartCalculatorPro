...
# Bangla Phonetic Transliteration helper for Bengali pronunciation (bn_pronoun)
def get_bn_pronoun(word):
    pronoun_map = {
        ...
        "encroach": "এনক্রোচ", "endanger": "এনডেঞ্জার", "endeavor": "এনডেভার", "endendor": "এনডোর",
        ...
        "erudite": "এরুডাইট", "rupt": "ইরাপ্ট", "escalate": "এসকেলেশন", "escape": "এসকেপ",
        "esoteric": "এসোটেরিক", "essential": "এসেনশিয়াল", "establish": "এস্টাবলিশ", "esteem": "এস্টিম",
        "aesthetic": "এসথেটিক", "estimate": "এস্টিমেট", "eternal": "ইটারনাল", "ethical": "ইথিক্যাল",
    ...
    # Capitalize simple phonetic heuristic for rest
    res = word.capitalize()
    return res

print("Pronunciation engine configured...")
